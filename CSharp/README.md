...
## PasswordGrant
The PasswordGrant sample demonstrates the use of the *password* grant type. This is the simplest of the OAuth flows and consists of the application providing a form to capture the username and password of the user and exchanging those credentials for an access token.
...
**Note: If you wish use this flow with non-staff users, you must also pass the tenantKey parameter. 

## AuthorizationCodeFlow
The AuthorizationCodeFlow sample demonstrates the use of the *code* flow. This is the preferrable method of obtaining an access token but is a little more complicated than that of the *password* grant type. 
...
**Note: If you do want to show your users the consent screen, you can enable a setting in the back office to bypass showing this page to users. 
